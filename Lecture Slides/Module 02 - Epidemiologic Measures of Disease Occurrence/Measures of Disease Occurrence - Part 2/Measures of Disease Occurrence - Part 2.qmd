...
- If 10 people experience the event of interest, what is the incidence rate?
  ...
  - The unit is $\text{0.02} \text{ years}^{-1}$. This reciprocal time unit means that, on average, 2% of the population at risk will experience the event each year.
...
- So, when we see a rate written as $\text{0.02} \text{ years}^{-1}$, it literally means 0.02 per year or $\frac{0.02}{\text{year}}$.
...
## Why Adjust a Rate? {.compact visibility="hidden"}

<!-- This example needs work. It was really hard for me to explain and for students to understand. -->
...
## Age Adjustment: Use the Same Age Mix {.compact visibility="hidden"}

<!-- I didn't really try to explain this slide because we didn't make it through the previous slide. -->
...
## Review: Incidence Rates {#incidence-rates .quiz}

<!-- Students seemed to like having quiz questions at the end. They don't love switching back and forth between slides and Poll Everywhere. -->
