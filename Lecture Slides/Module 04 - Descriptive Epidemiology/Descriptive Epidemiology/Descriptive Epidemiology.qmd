...
<!-- Consider adding a section break: Study Designs. -->
...
<!-- Consider adding the slide with the hierarchy of study designs. -->
...
## Case Reports: Example {.case-report-example}

<!-- Don't have students read from this slide on the screen. Provdide them with the article or a link to the article. -->
...
## Case Series: Example {.case-report-example}
...
<!-- Figure out what you want to say while presenting this slide. -->

![](assets/source-012-shape-4.jpg){fig-alt=""}


## Cross-Sectional Study: Example {.case-report-example}
...
<!-- Consider breaking this up into multiple slides. -->
<!-- Consider creating a COL question. -->
<!-- Talk about chromosomes vs social norms, -->
